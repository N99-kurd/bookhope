...
browseBtn: "Browse Books",
    ...
    ku: {
        ...
        heroDesc: "ئەو پەرتووکێن تە دڤێت بخوینی داخاز بکە، ئه‌م دێ بۆ تە هنێرین ",
        browseBtn: "ل پەرتووکان بگەره",
        availableBooksTitle: "پەرتووکێن بەردەست",
        clickToRequest: "كليك بکە بۆ داخازكرنێ",
        requestBtn: "دخازکرنا ڤێ پەرتووکێ",
        detailsBtn: "هوورکاری",
        author: "نڤیسەر",
        contactUs: " پەیوەندیێ ب مە بکە ",
        quickLinks: "بەستەرێن بله ز",
        followUs: "د گەل مه بە ",
        footerHome: "سەرەکی",
        navHome: "سەرەکی",
navBrowse: "گەڕان لە کتێبەکاندا",
        footerBooks: " گەڕیان د پەرتووکان د ",
        footerTagline: "بخوينه، گەشە بکه، گۆڕانکاریێ بپەیژینە",
        copyright: "© بوک هۆپ. هەمی ماف پاراستینە ",
        requestTitle: "داخازكرنا ڤێ پەرتووکێ",
        yourName: " ناڤێ ته",
        shippingAddress: "ناڤونیشانێ ته",
        submit: "هنارتنا داخازيى",
        successMessage: "داخازيا ته ب سەرکەفتيانه هاته هنارتن!",
